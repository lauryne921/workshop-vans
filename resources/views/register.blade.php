  ...
  <main class="bg-white p-8 rounded shadow-md flex flex-col md:flex-row w-full max-w-4xl">
    ...
    <div class="w-full md:w-1/2">
      <div class="text-center mb-6">
        <h1 class="text-4xl font-bold">Inscrivez-vous à l'évènement</h1>
      </div>

      <p class="text-xs">Inscrivez-vous à notre évènement et tentez votre chance d'être tiré au sort pour repartir avec une de nos 200 paires exclusives à ces Jeux Olympiques 2024 de Paris.</p>
      <p class="text-xs">Vous recevrez un mail dans quelques jours pour connaitre la réponse.</p><br>
      ...
      <form method="POST" action="{{ route('register') }}">
        ...
        <button type="submit" class="bg-black text-white py-2 px-4 mt-2.5 rounded w-full">S'inscrire</button>
      </form>
    </div>
  </main>
